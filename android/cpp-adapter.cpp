...
// Automated testing checks Java_com_nostrsdkreactnative_NostrSdkReactNativeModule and nostrsdkreactnative
...
Java_com_nostrsdkreactnative_NostrSdkReactNativeModule_nativeInstallRustCrate(
    ...
    return nostrsdkreactnative::installRustCrate(*runtime, jsCallInvoker);
}
...
Java_com_nostrsdkreactnative_NostrSdkReactNativeModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return nostrsdkreactnative::cleanupRustCrate(*runtime);
}